...
<div id="content">
  ...
  <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="20">
    <tr> 
     <td class="contentArea"><form action=checkNV.php method=post>
       <p>&nbsp;</p>
       <table width="350" border="1" align="center" cellpadding="5" cellspacing="1" class="entryTable">
        <tr id="entryTableHeader"> 
         <td align="center" bgcolor="#0033FF" ><b>Mời Nhân Viên Đăng Nhập</b></td>
        </tr>
        <tr> 
         <td class="contentArea"> 
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           ...
           <tr class="text"> 
            ...
            <td><input name="maNvien" type="text" class="box" id="txtUserName" value="" size="25" maxlength="40"></td>
           </tr>
           <tr> 
