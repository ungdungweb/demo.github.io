<script type="text/javascript">
	function QLbenhnhanupdate(){
	var f=document.regForm;
	if(f.tenbn.value=='') { alert('Banh chưa nhập tên bệnh nhân'); return false;}
	
	if(f.gioitinh.value=='') { alert('Banh chưa nhập gioi tinh'); return false;}
	if(f.diachi.value=='') { alert('Banh chưa nhập địa chỉ'); return false;}
	if(f.cmnd.value=='') { alert('Banh chưa nhập CMND'); return false;}
	if(f.ngaysinh.value=='') { alert('Banh chưa nhập ngày sinh'); return false;}
	if(f.dantoc.value=='') { alert('Banh chưa nhập dân tộc'); return false;}
	if(f.nn.value=='') { alert('Banh chưa nhập nghề nghiệp'); return false;}
	if(f.khoa.value=='') { alert('Banh chưa nhập khoa'); return false;}
	if(f.bhyt.value!='')
	{
			if(f.ngoaituyen.value=='') { alert('Loại Nào'); return false;}
			if(f.ngoaituyen.value==0 && f.gioithieu.value=='' ) { alert('Có giấy không'); return false;}
	}
...
<div id="content" >
  ...
  <form action="updateBN.php" method="post" name="regForm">
<div class="giua">
    	<div class="phangiua1">    
       ...
       <div class="phangiua2">
           ...
           <tr> 
            ...
            <TD style="font-size:19px">
             	<select name="dantoc" >
                <option value=""<?php echo $dantoc ?>"">Chọn dân tộc</option>                               
           ...
           <tr class="text"> 
            ...
            <td width="10" align="center">:</td>
            <td><input name="nn" type="text" class="box" id="nn" value="<?php echo $nghenghiep ?>" size="25" maxlength="40"></td>
           </tr>
           <tr> 
            <td width="100" align="left">BHYT</td>
            <td width="10" align="center">:</td>
             <td><input name="bhyt" type="text" class="box" id="bhyt" value="<?php echo $BHYT ?>" size="25" maxlength="40"></td>
           </tr>
            <tr class="text"> 
        ...
        <div class="btn">
                <tr >
                   <input type="hidden" name="sua2" value="<?php echo $id;?>" onclick="return QLbenhnhanupdate();" /> <br /><br />
