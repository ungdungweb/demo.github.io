...
<?php
if(isset($_POST["khoa"])&& isset($_POST["mabs"])&& isset($_POST["ngaykham"])&& isset($_POST["giokham"]) && isset($_POST["dienthoai"])&& isset($_POST["email"]))
		{
			$khoa=$_REQUEST["khoa"];
			$mabs=$_REQUEST["mabs"];
	...
	$ms=$row['0'];
	  ...
	  /*----------------------------*/	
	  	...
	  	if($giodk >2)
			{
				echo "<script>alert('Không thể đặt lịch khám xin vui lòng chọn bác sĩ khác,ngày khám hoặc buổi khám khác');</script><meta http-equiv='refresh' content='0; url=datlichkhamBN.php'>";
			}
			else
			{
