...
<form action="themttdangkinhi.php" id="form0" method="post">       <!-- Step Hinh Thuc Kham -->       
    ...
    <div id="block-inner-right-2-middle">
        ...
        <div class="block-inner-right-2-content">
            ...
            <p class="for-form">
               ...
               <td><input name="ngaysinh" type="hidden" class="box" id="txtUserName1" value="<?php echo $ngaysinh; ?>" size="25" maxlength="40"><?php echo $ngaysinh; ?>
